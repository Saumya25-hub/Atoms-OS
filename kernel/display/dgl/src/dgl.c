...
bool dgl_can_draw(bram_module_id_t module_id) {
    /* STRICT CTO SINGLE-OWNER GOVERNANCE:
     * During Quiet Boot or DGL_STATE_BOOT, ONLY ROOK ENGINE IS ALLOWED TO presenting frames to VRAM.
     * All legacy debug panels (ABDE, Cursor Cert, USB, LAN) are 100% BLOCKED.
     */
