...
// Font Object
// Contains all typography properties and holds reference to the generated glyph
// atlas.
...
typedef struct BOFont {
  ...
  BOTexture atlas_texture_storage; // Inline descriptor for resident
                                   // asset-backed atlases
...
// Text Layout Item
// Represents a single positioned glyph ready for submission to BOIMAGE batch
// queue.
