...
// AC97 Bus Master Status Register (SR offset 0x16 / 0x06) symbolic masks
#define AC97_SR_DCH                  0x01 // DMA Controller Halted (RO)
#define AC97_SR_CELV                 0x02 // Current Equals Last Valid (RO)
#define AC97_SR_LVBCI                0x04 // Last Valid Buffer Completion Interrupt (R/WC)
#define AC97_SR_BCIS                 0x08 // Buffer Completion Interrupt Status (R/WC)
#define AC97_SR_FIFOE                0x10 // FIFO Error (R/WC)
#define AC97_SR_WC_CLEAR_MASK        (AC97_SR_LVBCI | AC97_SR_BCIS | AC97_SR_FIFOE) // 0x1C
