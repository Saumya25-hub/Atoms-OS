...
uint64_t ATOMS_KernelService_Dispatch(uint32_t service_nr, uint64_t arg1,
  ...
  case SYS_WINDOW_CREATE:
    return ATOMS_CreateWindowForApp((uint32_t)arg1, (int32_t)arg2,
                                    (int32_t)arg3, 400, 300, (const char *)arg4,
                                    0);
  ...
  case SYS_FILESYSTEM_OPEN:
    return (uint64_t)ATOMS_VFS_OpenFile((uint32_t)arg1, (const char *)arg2,
                                        (const char *)arg3);

  case SYS_FILESYSTEM_READ:
    return (uint64_t)ATOMS_VFS_ReadFile((int32_t)arg1, (void *)arg2,
                                        (uint32_t)arg3);

  case SYS_FILESYSTEM_WRITE:
    return (uint64_t)ATOMS_VFS_WriteFile((int32_t)arg1, (const void *)arg2,
                                         (uint32_t)arg3);
  ...
  case SYS_DIALOG_SHOW:
    return ATOMS_ShowMessageBox((uint32_t)arg1, (const char *)arg2,
                                (const char *)arg3, ATOMS_DIALOG_ICON_INFO, 0);
