...
uint32_t scheduler_get_sleeping_count(void);
uint32_t scheduler_get_blocked_count(void);
uint64_t scheduler_get_last_switch_from(void);
uint64_t scheduler_get_last_switch_to(void);
