...
void netif_init(void) {
    ...
    // Static IP configuration for QEMU SLIRP user network in Network Byte Order
    // IP: 10.0.2.15
    g_default_netif.ip_addr = htonl((10U << 24) | (0U << 16) | (2U << 8) | 15U);
    // Subnet: 255.255.255.0
    g_default_netif.netmask = htonl(0xFFFFFF00U);
    // Gateway: 10.0.2.2
    g_default_netif.gateway_ip = htonl((10U << 24) | (0U << 16) | (2U << 8) | 2U);
}
