...
void D_BindVariables(void)
{
    ...
    const char* macros[] = {"chatmacro0", "chatmacro1", "chatmacro2", "chatmacro3", "chatmacro4", "chatmacro5", "chatmacro6", "chatmacro7", "chatmacro8", "chatmacro9"};
    for (i=0; i<10; ++i)
    {
        M_BindVariable((char*)macros[i], &chat_macros[i]);
    }
}
