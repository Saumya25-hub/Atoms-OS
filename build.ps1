...
clang -target x86_64-pc-none-elf -mno-sse -mno-sse2 -mno-mmx -msoft-float -ffreestanding -mno-red-zone -I. -c kernel\browser_engine\html\abe_html.c -o build\abe_html.o
if ($LASTEXITCODE -ne 0) { Write-Host "ABE HTML Subsystem Failed!" -ForegroundColor Red; exit $LASTEXITCODE }
clang -target x86_64-pc-none-elf -mno-sse -mno-sse2 -mno-mmx -msoft-float -ffreestanding -mno-red-zone -I. -c kernel\browser_engine\dom\abe_dom.c -o build\abe_dom.o
if ($LASTEXITCODE -ne 0) { Write-Host "ABE DOM Subsystem Failed!" -ForegroundColor Red; exit $LASTEXITCODE }
clang -target x86_64-pc-none-elf -mno-sse -mno-sse2 -mno-mmx -msoft-float -ffreestanding -mno-red-zone -I. -c kernel\browser_engine\css\abe_css.c -o build\abe_css.o
if ($LASTEXITCODE -ne 0) { Write-Host "ABE CSS Subsystem Failed!" -ForegroundColor Red; exit $LASTEXITCODE }
clang -target x86_64-pc-none-elf -mno-sse -mno-sse2 -mno-mmx -msoft-float -ffreestanding -mno-red-zone -I. -c kernel\browser_engine\layout\abe_layout.c -o build\abe_layout.o
if ($LASTEXITCODE -ne 0) { Write-Host "ABE Layout Subsystem Failed!" -ForegroundColor Red; exit $LASTEXITCODE }
clang -target x86_64-pc-none-elf -mno-sse -mno-sse2 -mno-mmx -msoft-float -ffreestanding -mno-red-zone -I. -c kernel\browser_engine\javascript\abe_js.c -o build\abe_js.o
if ($LASTEXITCODE -ne 0) { Write-Host "ABE JavaScript VM Subsystem Failed!" -ForegroundColor Red; exit $LASTEXITCODE }
