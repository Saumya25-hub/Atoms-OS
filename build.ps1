...
ld.lld --Map=build\kernel.map -T kernel\linker.ld build\kernel_entry.o build\kernel.o build\ap_trampoline.o build\smp.o build\spinlock.o build\phase7_reliability.o build\phase7_cert.o build\loader_debug.o build\loader_elf_parser.o build\loader_symbol_resolver.o build\loader_reloc_engine.o build\loader_segment_loader.o build\loader_library_manager.o build\loader_runtime_linker.o build\loader_manager.o build\loader_tests.o build\ipc_debug.o build\ipc_sync.o build\ipc_permissions.o build\ipc_channel_manager.o build\ipc_message_queue.o build\ipc_pipe_engine.o build\ipc_port_manager.o build\ipc_shm_manager.o build\ipc_router.o build\ipc_manager.o build\ipc_tests.o build\sec_debug.o build\sec_diag.o build\sec_random.o build\sec_sha256.o build\sec_sha384.o build\sec_sha512.o build\sec_aes.o build\sec_rsa.o build\sec_ecc.o build\sec_crypto_manager.o build\sec_x509.o build\sec_cert_validator.o build\sec_trust_store.o build\sec_session.o build\sec_cipher_suite.o build\sec_key_exchange.o build\sec_tls_engine.o build\sec_manager.o build\sec_test_suite.o build\sb_manager.o build\sb_process.o build\sb_token.o build\sb_capability.o build\sb_permissions.o build\sb_memory.o build\sb_syscall.o build\sb_ipc.o build\sb_filesystem.o build\sb_network.o build\sb_resource.o build\sb_audit.o build\sb_debug.o build\sb_tests.o build\html_debug.o build\html_diag.o build\html_attr.o build\html_node.o build\html_elem.o build\html_text.o build\html_comment.o build\html_doctype.o build\html_frag.o build\html_doc.o build\html_mut.o build\html_ser.o build\html_tok.o build\html_tb.o build\html_parser.o build\html_bos.o build\html_tests.o build\css_tok.o build\css_val.o build\css_spec.o build\css_sel.o build\css_rule.o build\css_sheet.o build\css_parser.o build\css_style.o build\css_bos.o build\css_tests.o build\cpu_features.o build\cpu_state.o build\test_cpu_phase0.o build\bgl_drawable.o build\bgl_context.o build\bgl.o build\test_bgl_phase1.o build\gl_math.o build\gl_state.o build\gl_pipeline.o build\gl_clip.o build\gl_viewport.o build\gl_depth.o build\gl_texture.o build\gl_sampler.o build\gl_lighting.o build\gl_fragment.o build\gl_point.o build\gl_line.o build\gl_vertex_fetch.o build\gl_display_list.o build\gl_rasterizer.o build\gl_fbo.o build\gl.o build\test_gl_phase2.o build\test_gl_phase3.o build\test_gl_phase4.o build\test_gl_phase5.o build\test_gl_phase6.o build\test_gl_phase7.o build\test_gl_phase8.o build\test_gl_phase9.o build\test_gl_phase10.o build\atoms_graph_metrics.o build\atoms_graph_scene.o build\atoms_graph_renderer.o build\atoms_graph_ui.o build\atoms_graph_benchmark.o build\atoms_graph_3d.o build\test_gl_phase11.o build\gpu_manager.o build\gpu_pci.o build\gpu_memory.o build\gpu_surface_hal.o build\gpu_drv_vmware.o build\gpu_drv_virtio.o build\gpu_drv_intel.o build\gpu_drv_amd.o build\gpu_drv_nvidia.o build\gpu_drv_swrender.o build\gpu_debug.o build\edid_parser.o build\display_manager.o build\dve_framebuffer.o build\dve_geometry.o build\dve_pixel_format.o build\dve_surface.o build\dve_gpu_driver.o build\dve_display_mode.o build\dve_presentation.o build\dve_memory_safety.o build\dve_frame_integrity.o build\dve_report.o build\dve_certification_tests.o build\dpdp.o build\dpdp_preview.o build\dpdp_registers.o build\dpdp_timeline.o build\dpdp_tests.o build\gpu_tests.o build\pci.o build\e1000.o build\netif.o build\ethernet.o build\arp.o build\ipv4.o build\icmp.o build\udp.o build\dhcp.o build\dns.o build\tcp.o build\http.o build\tls_record.o build\tls_handshake.o build\tls.o build\sha256.o build\hmac_sha256.o build\tls_prf.o build\aes.o build\gcm.o build\crypto_rand.o build\tls_crypto.o build\rsa.o build\x509.o build\x509_verify.o build\trust_store.o build\rtc.o build\tls_test.o build\net_service.o build\socket_manager.o build\socket.o build\socket_test.o build\xhci.o build\xhci_dma.o build\xhci_ring.o build\xhci_cmd.o build\xhci_transfer.o build\usb_enum.o build\usb_registry.o build\usb_transfer.o build\usb_hid.o build\bte_transfer_ring.o build\bte_command_ring.o build\bte_event_ring.o build\bte_queue_manager.o build\bte_scheduler.o build\bte_bulk_in.o build\bte_bulk_out.o build\bte_bulk_submit.o build\bte_bulk_complete.o build\bte_msi.o build\bte_event_handler.o build\bte_telemetry.o build\bte_forensic_dump.o build\bte_ai_debug.o build\bte_timeout.o build\bte_bulk_tests.o build\lhce_usb_dma.o build\lhce_usb_scheduler.o build\lhce_controller_manager.o build\lhce_uhci.o build\lhce_ohci.o build\lhce_ehci.o build\lhce_telemetry.o build\lhce_forensic_dump.o build\lhce_ai_debug.o build\lhce_certification_tests.o build\ucue_usb_core.o build\ucue_usb_urb.o build\ucue_usb_endpoint.o build\ucue_usb_pipe.o build\ucue_usb_request_queue.o build\ucue_usb_transfer_dispatcher.o build\ucue_usb_resource_manager.o build\ucue_usb_timeout_engine.o build\ucue_usb_completion_engine.o build\ucue_diagnostics.o build\ucue_certification_tests.o build\uhe_hub_manager.o build\uhe_hub_enumeration.o build\uhe_hub_topology.o build\uhe_hub_registry.o build\uhe_port_power.o build\uhe_port_reset.o build\uhe_port_events.o build\uhe_port_status.o build\uhe_port_recovery.o build\uhe_telemetry.o build\uhe_forensic_dump.o build\uhe_ai_debug.o build\uhe_hub_certification_tests.o build\ums_cbw.o build\ums_csw.o build\ums_recovery.o build\ums_transport.o build\ums_bot_engine.o build\ums_scsi_inquiry.o build\ums_scsi_read_capacity.o build\ums_scsi_request_sense.o build\ums_scsi_read10.o build\ums_scsi_write10.o build\ums_scsi_test_unit_ready.o build\ums_scsi_mode_sense.o build\ums_scsi_engine.o build\ums_telemetry.o build\ums_forensic_dump.o build\ums_ai_debug.o build\ums_bot_scsi_certification_tests.o build\usm_disk_manager.o build\usm_partition_manager.o build\usm_volume_manager.o build\usm_mount_manager.o build\usm_storage_manager.o build\usm_sector_cache.o build\usm_block_cache.o build\usm_io_scheduler.o build\usm_vfs_bridge.o build\usm_telemetry.o build\usm_forensic_dump.o build\usm_ai_debug.o build\usm_storage_manager_tests.o build\vizier_core.o build\port_io.o build\idt.o build\isr_stubs.o build\isr.o build\exception.o build\irq.o build\pic.o build\timer.o build\pit.o build\keyboard.o build\ps2.o build\ps2_mouse.o build\bce_cur_loader.o build\bce_ani_loader.o build\bce_cursor_cache.o build\bce_cursor_theme.o build\bce_cursor_animation.o build\bce_cursor_hal.o build\bce_cursor_diag.o build\bce_bos_cursor.o build\bce_cursor_tests.o build\vbe.o build\bv_core.o build\bv_graphics.o build\bv_text.o build\bv_drawing.o build\bv_renderer.o build\bv_cursor_manager.o build\bv_controls.o build\bwe_core.o build\bwe_process_queue.o build\bwe_window.o build\bwe_geometry.o build\bwe_render_context.o build\bwe_diagnostics.o build\bwe_compositor.o build\bwe_paint.o build\botheme.o build\bwe_theme.o build\bwe_layout.o build\bwe_controls.o build\bwe_demo_app.o build\atoms_app_manager.o build\atoms_app_loader.o build\atoms_app_permissions.o build\atoms_app_window_api.o build\atoms_app_clipboard.o build\atoms_app_dialogs.o build\atoms_app_vfs_api.o build\atoms_app_runtime.o build\atoms_app_debug.o build\atoms_execution_contract.o build\atoms_user_mode.o build\atoms_user_mode_certification.o build\atoms_process_manager.o build\atoms_thread_manager.o build\atoms_sll_manager.o build\atoms_bkm_manager.o build\atoms_syscall_gateway.o build\atoms_app_installer.o build\atoms_bosx_stress.o build\atoms_network_manager.o build\atoms_http_client.o build\atoms_net_security.o build\atoms_net_stress.o build\atrix_browser_engine.o build\atrix_browser_tabs.o build\atrix_html_parser.o build\atrix_css_parser.o build\atrix_css_layout.o build\atrix_render_tree.o build\atrix_js_runtime.o build\atrix_browser_http.o build\atrix_browser_stress.o build\atrix_browser_url.o build\atrix_browser_navigation.o build\atrix_html_document.o build\atrix_paint_engine.o build\atrix_layout_engine.o build\atrix_browser_download.o build\abe_core.o build\abe_config.o build\abe_feature.o build\abe_process.o build\abe_session.o build\abe_window.o build\abe_tab.o build\abe_url.o build\abe_navigation.o build\abe_resource.o build\abe_api.o build\abe_render.o build\abe_diagnostics.o build\adf_core.o build\adf_snapshot.o build\adf_inspector.o build\abe_phase1_test.o build\abe_net_dns.o build\abe_net_tls.o build\abe_net_conn.o build\abe_net_http.o build\abe_net_parser.o build\abe_net_redirect.o build\abe_net_compress.o build\abe_net_download.o build\abe_net_manager.o build\abe_net_test.o build\abe_html_tokenizer.o build\abe_dom_node.o build\abe_html_element.o build\abe_html_parser.o build\abe_html_text.o build\abe_html_document.o build\abe_html_api.o build\abe_html_test.o build\abe_css_tokenizer.o build\abe_css_parser.o build\abe_css_selector.o build\abe_css_cascade.o build\abe_css_inherit.o build\abe_css_computed.o build\abe_css_style_manager.o build\abe_css_api.o build\abe_css_test.o build\abe_render_tree.o build\abe_box_model.o build\abe_block_layout.o build\abe_inline_layout.o build\abe_flex_layout.o build\abe_positioning.o build\abe_reflow.o build\abe_layout_diag.o build\abe_layout_api.o build\abe_layout_test.o build\abe_js_lexer.o build\abe_js_parser.o build\abe_js_compiler.o build\abe_js_vm.o build\abe_js_gc.o build\abe_js_objects.o build\abe_js_promise.o build\abe_js_event_loop.o build\abe_js_dom_binding.o build\abe_js_module.o build\abe_js_diag.o build\abe_js_api.o build\abe_js_test.o build\abe_web_fetch.o build\abe_web_xhr.o build\abe_web_url.o build\abe_web_storage.o build\abe_web_history.o build\abe_web_navigator.o build\abe_web_performance.o build\abe_web_scheduler.o build\abe_web_observers.o build\abe_web_blob.o build\abe_web_form.o build\abe_web_diag.o build\abe_web_api.o build\abe_web_test.o build\bv_geometry.o build\bv_boscal.o build\bv_images.o build\bv_layout.o build\bv_input.o build\kernel_input.o build\input_abstraction.o build\hida.o build\ccte.o build\input_core.o build\input_adapter.o build\pointer_state.o build\pointer_precision.o build\pointer_velocity.o build\pointer_buttons.o build\pointer_bounds_v2.o build\pointer_consumers.o build\pointer_motion.o build\pointer_engine.o build\dispatcher_priority.o build\dispatcher_queue.o build\dispatcher_diag.o build\dispatcher_consumers.o build\dispatcher_filters.o build\dispatcher_router.o build\dispatcher.o build\cursor_state.o build\cursor_hotspot.o build\cursor_theme.o build\cursor_animation.o build\cursor_diag.o build\cursor_backend.o build\cursor_renderer.o build\cursor_engine.o build\usb_tablet.o build\vmmouse.o build\ivdl.o build\pointer_diag.o build\pointer_predict.o build\pointer_filter.o build\pointer_sync.o build\pointer_manager.o build\mouse_engine.o build\bmde.o build\vga.o build\console.o build\display.o build\pmm.o build\bitmap.o build\vmm.o build\paging.o build\\heap.o build\\amsss_coordinator.o build\\amsss_pressure.o build\\amsss_health.o build\\amsss_diagnostic.o build\\amsss_heap_backend.o build\list.o build\crash_log.o build\runqueue.o build\task.o build\context.o build\context_switch.o build\syscall.o build\syscall_wrappers.o build\syscall_entry.o build\gui_events.o build\gdt.o build\gdt_flush.o build\enter_usermode.o build\scheduler.o build\bre.o build\block_device.o build\ata.o build\mbr.o build\disk_manager.o build\vfs.o build\string.o build\fat32.o build\ntfs.o build\ntfs_test.o build\elf_validate.o build\elf_segment.o build\process_builder.o build\process.o build\bosx_loader.o build\conhost.o build\boimage.o build\boasset.o build\asset_cache.o build\asset_loader.o build\font_loader.o build\glyph_cache.o build\glyph_atlas.o build\text_layout.o build\bofont.o build\bofont_assets.o build\rook_core.o build\rook_registry.o build\rook_render.o build\rook_debug.o build\spinner.o build\page_boot.o build\boot_assets.o build\wallpaper_service.o build\user_profile_service.o build\page_login.o build\bomatrix.o build\desktop_shell.o build\dom.o build\desktop_vfs_sync.o build\desktop_watcher.o build\desktop_certification_tests.o build\horse_engine.o build\task_panel.o build\start_menu.o build\bos_shell_panel.o build\system_hub.o build\apps.o build\kernel_shell_os_stubs.o build\kernel_command.o build\kernel_commands_sys.o build\input_lab.o build\atrix_browser.o build\atoms_tmh_provider.o build\tmh_app.o build\explorer.o build\explorer_view.o build\explorer_cache.o build\notes_app.o build\rename_dialog.o build\app_clipboard.o build\audio_api.o build\audio_core.o build\audio_realtime_worker.o build\audio_debug.o build\audio_diagnostic_mode.o build\ac97.o build\ac97_codec.o build\ac97_dma.o build\ac97_playback.o build\audio_forensic.o build\audio_pcm.o build\audio_driver_registry.o build\audio_hal.o build\audio_mixer.o build\audio_mix_math.o build\audio_player.o build\audio_producer_worker.o build\audio_buffer.o build\audio_stream.o build\audio_volume.o build\audio_test_mode.o build\bopawn.o build\surface.o build\bopawn_loader.o build\bopawn_cache.o build\bopawn_converter.o build\bopawn_raw.o build\bopawn_bmp.o build\bopawn_ico.o build\bopawn_png.o build\bopawn_crc.o build\bopawn_inflate.o build\bopawn_filters.o build\wallpaper_registry.o build\wallpaper_scaler.o build\wallpaper_manager.o build\wallpaper_settings.o build\animation_engine.o build\animation_timeline.o build\animation_easing.o build\animation_scheduler.o build\animation_fade.o build\ame_core.o build\ame_easing.o build\ame_spinner.o build\ame_modules.o build\identity.o build\display_hal.o build\vbe_driver.o build\present_queue.o build\damage_tracker.o build\swapchain.o build\frame_pacer.o build\cursor_plane.o build\bspe_cursor_present.o build\bspe_present.o build\vram_copy.o build\dual_page_present.o build\telemetry_hud.o build\step14_telemetry.o build\profiler.o build\frame_profiler.o build\render_profiler.o build\sched_profiler.o build\mem_profiler.o build\present_profiler.o build\stats_profiler.o build\report_profiler.o build\profiler_tests.o build\pacing_analyzer.o build\boot_mode.o build\deferred_work.o build\agdte_timing.o build\agdte_display_state.o build\agdte_buffer_manager.o build\agdte_surface_manager.o build\agdte_present_queue.o build\agdte_scheduler.o build\agdte_backend.o build\agdte_diag.o build\agdte_presenter.o build\agdte.o build\agdte_present_timeline.o build\agdte_frame_metrics.o build\agdte_vsync.o build\agdte_frame_pacer.o build\agdte_refresh_controller.o build\agdte_swap_controller.o build\quality_engine.o build\frame_stabilizer.o build\motion_analyzer.o build\dirty_optimizer.o build\cadence_optimizer.o build\presentation_diag.o build\display_metrics.o build\present_quality.o build\die_manager.o build\die_detection.o build\die_capabilities.o build\die_policy.o build\die_geometry.o build\die_layout.o build\die_runtime.o build\die_diag.o build\bocompositor.o build\compositor_clip.o build\compositor_damage.o build\compositor_stack.o build\compositor_surface.o build\agdpe_core.o build\agdpe_vbe_driver.o build\agdae_core.o build\agdae_diag.o build\agdae_geometry.o build\agdae_scaling.o build\bdce_authority.o build\bdce_validation.o build\bos_pack_loader.o build\bos_manifest.o build\bos_elf_loader.o build\bos_sdk_runtime.o build\bos_installer.o build\bosfsr_core.o build\bosfsr_graphics.o build\bosfsr_containers.o build\bosfsr_controls.o build\bosfsr32.o  build\agp_runtime.o build\agp_context.o build\agp_surface.o build\agp_swapchain.o build\agp_display.o build\agp_window.o build\agp_commands.o build\agp_texture.o build\agp_buffer.o build\agp_shader.o build\agp_pipeline.o build\agp_sync.o build\agp_opengl_rt.o build\agp_opengl_loader.o build\agp_egl.o build\agp_resources.o build\agp_diagnostics.o build\agp_profiler.o build\agp_vram.o build\agp_scheduler.o build\opengl32.o build\agp_certification_tests.o  build\botree_init.o build\bde_path_normalize.o build\bde_path_canonical.o build\bde_path_split.o build\bde_path_compare.o build\bde_nav_session.o build\bde_namespace_core.o build\bde_cache_dir.o build\bde_transaction_queue.o build\bde_cmd_handlers.o build\bde_permission_acl.o build\bde_watcher_hub.o build\bde_clipboard_store.o build\bde_shortcut_resolver.o build\bde_metadata_query.o build\bde_recycle_bin.o build\dre_core.o build\dre_navigator.o build\dre_enumerator.o build\dre_selection.o build\dre_sort.o build\dre_filter.o build\dre_certification_tests.o build\bdr_core.o build\bdr_icons.o build\bdr_grid.o build\bdr_selection.o build\bdr_wallpaper.o build\bdr_notifications.o build\bdr_devices.o build\bdr_diagnostics.o build\bdr_certification_tests.o build\bsr_core.o build\bsr_dispatcher.o build\bsr_file_association.o build\bsr_launcher.o build\bsr_search.o build\bsr_recent.o build\bsr_favorites.o build\bsr_notifications.o build\bsr_dialogs.o build\bsr_diagnostics.o build\bsr_certification_tests.o build\brt_core.o build\brt_registry.o build\brt_dispatcher.o build\brt_objects.o build\brt_session.o build\brt_cache.o build\brt_events.o build\brt_clipboard.o build\brt_dragdrop.o build\brt_notifications.o build\brt_search.o build\brt_security.o build\brt_transactions.o build\brt_diagnostics.o build\brt_certification_tests.o build\bfs_core.o build\bfs_file_manager.o build\bfs_copy.o build\bfs_move.o build\bfs_delete.o build\bfs_rename.o build\bfs_create.o build\bfs_properties.o build\bfs_locking.o build\bfs_association.o build\bfs_mime.o build\bfs_icons.o build\bfs_thumbnails.o build\bfs_recycle.o build\bfs_recent.o build\bfs_favorites.o build\bfs_quickaccess.o build\bfs_metadata.o build\bfs_search.o build\bfs_transactions.o build\bfs_diagnostics.o build\bfs_certification_tests.o build\bsom_core.o build\bsom_registry.o build\bsom_factory.o build\bsom_handles.o build\bsom_lifetime.o build\bsom_resolver.o build\bsom_namespace.o build\bsom_properties.o build\bsom_icons.o build\bsom_thumbnails.o build\bsom_clipboard.o build\bsom_dragdrop.o build\bsom_search.o build\bsom_recent.o build\bsom_favorites.o build\bsom_recycle.o build\bsom_permissions.o build\bsom_metadata.o build\bsom_cache.o build\bsom_diagnostics.o build\bsom_certification_tests.o build\explorer_rewrite_certification.o build\bar_runtime.o build\bar_process.o build\bar_session.o build\bar_registry.o build\bar_dll.o build\bar_message.o build\bar_dispatcher.o build\bar_windows.o build\bar_resources.o build\bar_dialogs.o build\bar_clipboard.o build\bar_dragdrop.o build\bar_timers.o build\bar_focus.o build\bar_packages.o build\bar_manifest.o build\bar_security.o build\bar_diagnostics.o build\bar_certification_tests.o build\user32_runtime.o build\user32_class.o build\user32_window.o build\user32_message.o build\user32_input.o build\user32_keyboard.o build\user32_mouse.o build\user32_focus.o build\user32_caret.o build\user32_cursor.o build\user32_clipboard.o build\user32_dragdrop.o build\user32_menus.o build\user32_dialogs.o build\user32_controls.o build\user32_timers.o build\user32_hooks.o build\user32_accelerators.o build\user32_diagnostics.o build\user32_certification_tests.o build\gdi32_runtime.o build\gdi32_dc.o build\gdi32_pen.o build\gdi32_brush.o build\gdi32_font.o build\gdi32_text.o build\gdi32_bitmap.o build\gdi32_image.o build\gdi32_region.o build\gdi32_clipping.o build\gdi32_painting.o build\gdi32_blit.o build\gdi32_alpha.o build\gdi32_geometry.o build\gdi32_colors.o build\gdi32_surfaces.o build\gdi32_paths.o build\gdi32_printing.o build\gdi32_diagnostics.o build\gdi32_certification_tests.o build\kernel32_runtime.o build\kernel32_process.o build\kernel32_thread.o build\kernel32_memory.o build\kernel32_heap.o build\kernel32_sync.o build\kernel32_mutex.o build\kernel32_semaphore.o build\kernel32_critical.o build\kernel32_events.o build\kernel32_files.o build\kernel32_directory.o build\kernel32_pipes.o build\kernel32_console.o build\kernel32_time.o build\kernel32_locale.o build\kernel32_environment.o build\kernel32_loader.o build\kernel32_tls.o build\kernel32_exceptions.o build\kernel32_atoms.o build\kernel32_performance.o build\kernel32_diagnostics.o build\kernel32_certification_tests.o build\comdlg32_runtime.o build\comdlg32_open_save.o build\comdlg32_folder.o build\comdlg32_color.o build\comdlg32_font.o build\comdlg32_print.o build\comdlg32_page_setup.o build\comdlg32_find_replace.o build\comdlg32_preview.o build\comdlg32_history.o build\comdlg32_favorites.o build\comdlg32_quickaccess.o build\comdlg32_sidebar.o build\comdlg32_filters.o build\comdlg32_navigation.o build\comdlg32_validation.o build\comdlg32_layout.o build\comdlg32_theme.o build\comdlg32_icons.o build\comdlg32_bookmarks.o build\comdlg32_diagnostics.o build\comdlg32_certification_tests.o build\comctl32_runtime.o build\comctl32_button.o build\comctl32_edit.o build\comctl32_static.o build\comctl32_listbox.o build\comctl32_combobox.o build\comctl32_listview.o build\comctl32_treeview.o build\comctl32_tab.o build\comctl32_toolbar.o build\comctl32_statusbar.o build\comctl32_progress.o build\comctl32_trackbar.o build\comctl32_header.o build\comctl32_imagelist.o build\comctl32_tooltip.o build\comctl32_rebar.o build\comctl32_updown.o build\comctl32_pager.o build\comctl32_animation.o build\comctl32_monthcal.o build\comctl32_datetime.o build\comctl32_hotkey.o build\comctl32_ipaddress.o build\comctl32_theme.o build\comctl32_layout.o build\comctl32_notifications.o build\comctl32_accessibility.o build\comctl32_diagnostics.o build\comctl32_certification_tests.o build\shell_runtime.o build\shell_desktop.o build\shell_explorer.o build\shell_namespace.o build\shell_specialfolders.o build\shell_recyclebin.o build\shell_shortcuts.o build\shell_icons.o build\shell_imagelist.o build\shell_contextmenu.o build\shell_fileassoc.o build\shell_execute.o build\shell_properties.o build\shell_clipboard.o build\shell_dragdrop.o build\shell_notifications.o build\shell_taskbar.o build\shell_tray.o build\shell_search.o build\shell_history.o build\shell_diagnostics.o build\shell32_certification_tests.o build\bos_bootstrap.o build\bos_loader.o build\bos_object.o build\bos_handles.o build\bos_process.o build\bos_thread.o build\bos_memory.o build\bos_vmem.o build\bos_heap.o build\bos_sync.o build\bos_exceptions.o build\bos_ipc.o build\bos_security.o build\bos_syscall.o build\bos_timer.o build\bos_performance.o build\bos_context.o build\bos_environment.o build\bos_diagnostics.o build\bosll_certification_tests.o build\opengl_runtime.o build\opengl_context.o build\opengl_pixel.o build\opengl_surface.o build\opengl_buffers.o build\opengl_textures.o build\opengl_shaders.o build\opengl_pipeline.o build\opengl_vertex.o build\opengl_framebuffer.o build\opengl_swap.o build\opengl_extensions.o build\opengl_dispatch.o build\opengl_errors.o build\opengl_state.o build\opengl_agp_translate.o build\opengl_performance.o build\opengl_resource.o build\opengl_diagnostics.o build\opengl32_certification_tests.o build\advapi_runtime.o build\advapi_registry.o build\advapi_reg_notify.o build\advapi_security.o build\advapi_sid.o build\advapi_acl.o build\advapi_tokens.o build\advapi_privilege.o build\advapi_services.o build\advapi_eventlog.o build\advapi_crypto.o build\advapi_policy.o build\advapi_lsa.o build\advapi_impersonation.o build\advapi_audit.o build\advapi_env.o build\advapi_handles.o build\advapi_performance.o build\advapi_diagnostics.o build\advapi32_certification_tests.o build\ws2_runtime.o build\ws2_socket.o build\ws2_tcp.o build\ws2_udp.o build\ws2_address.o build\ws2_interface.o build\ws2_dns.o build\ws2_transfer.o build\ws2_async.o build\ws2_events.o build\ws2_select.o build\ws2_poll.o build\ws2_options.o build\ws2_security.o build\ws2_buffers.o build\ws2_performance.o build\ws2_diagnostics.o build\ws2_compat.o build\ws2_resource.o build\ws2_32_certification_tests.o build\ole_runtime.o build\ole_com.o build\ole_iunknown.o build\ole_factory.o build\ole_objects.o build\ole_interfaces.o build\ole_clsid.o build\ole_iid.o build\ole_apartment.o build\ole_marshal.o build\ole_storage.o build\ole_stream.o build\ole_clipboard.o build\ole_dragdrop.o build\ole_dataobject.o build\ole_moniker.o build\ole_property.o build\ole_persist.o build\ole_diagnostics.o build\ole32_certification_tests.o build\explorer_runtime.o build\explorer_desktop.o build\explorer_session.o build\explorer_wallpaper.o build\explorer_icons.o build\explorer_taskbar.o build\explorer_startmenu.o build\explorer_tray.o build\explorer_browser.o build\explorer_navigation.o build\explorer_addressbar.o build\explorer_search.o build\explorer_contextmenu.o build\explorer_dragdrop.o build\explorer_clipboard.o build\explorer_recyclebin.o build\explorer_associations.o build\explorer_controlpanel.o build\explorer_settings.o build\explorer_favorites.o build\explorer_recent.o build\explorer_diagnostics.o build\explorer_certification_tests.o build\controlpanel_runtime.o build\controlpanel_loader.o build\controlpanel_category.o build\controlpanel_search.o build\controlpanel_navigation.o build\controlpanel_favorites.o build\controlpanel_history.o build\controlpanel_permissions.o build\controlpanel_settings.o build\controlpanel_plugin.o build\controlpanel_diagnostics.o build\bosc_modules.o build\controlpanel_certification_tests.o build\settings_runtime.o build\settings_dashboard.o build\settings_navigation.o build\settings_search.o build\settings_display.o build\settings_theme.o build\settings_personalization.o build\settings_sound.o build\settings_network.o build\settings_bluetooth.o build\settings_storage.o build\settings_accounts.o build\settings_privacy.o build\settings_updates.o build\settings_accessibility.o build\settings_devices.o build\settings_notifications.o build\settings_power.o build\settings_diagnostics.o build\settings_certification_tests.o build\terminal_runtime.o build\terminal_console.o build\terminal_parser.o build\terminal_commands.o build\terminal_history.o build\terminal_autocomplete.o build\terminal_aliases.o build\terminal_environment.o build\terminal_filesystem.o build\terminal_process.o build\terminal_script.o build\terminal_plugin.o build\terminal_diagnostics.o build\terminal_certification_tests.o build\taskmgr_runtime.o build\taskmgr_dashboard.o build\taskmgr_process.o build\taskmgr_threads.o build\taskmgr_memory.o build\taskmgr_cpu.o build\taskmgr_gpu.o build\taskmgr_storage.o build\taskmgr_network.o build\taskmgr_power.o build\taskmgr_services.o build\taskmgr_drivers.o build\taskmgr_modules.o build\taskmgr_handles.o build\taskmgr_hardware.o build\taskmgr_sensors.o build\taskmgr_performance.o build\taskmgr_graphs.o build\taskmgr_diagnostics.o build\taskmgr_certification_tests.o build\fe_runtime.o build\fe_navigation.o build\fe_addressbar.o build\fe_treeview.o build\fe_listview.o build\fe_namespace.o build\fe_drives.o build\fe_search.o build\fe_preview.o build\fe_thumbnail.o build\fe_clipboard.o build\fe_dragdrop.o build\fe_operations.o build\fe_properties.o build\fe_permissions.o build\fe_contextmenu.o build\fe_favorites.o build\fe_recent.o build\fe_history.o build\fe_shortcuts.o build\fe_refresh.o build\fe_watcher.o build\fe_forensic.o build\fe_diagnostics.o build\fe_certification_tests.o build\bospectra_core.o build\bospectra_state.o build\bospectra_debug.o build\bospectra_memory.o build\bospectra_file.o build\bospectra_packet.o build\bospectra_buffer.o build\bospectra_stream.o build\bospectra_container.o build\container_common.o build\container_registry.o build\mp4_parser.o build\mkv_parser.o build\avi_parser.o build\container_tests.o build\bospectra_frame_memory.o build\frame_pool.o build\packet_pool.o build\media_queue.o build\circular_ring.o build\frame_memory_diag.o build\frame_memory_tests.o build\bospectra_color.o build\yuv420_converter.o build\nv12_converter.o build\yuy2_converter.o build\rgb_converter.o build\color_pipeline.o build\color_diag.o build\color_tests.o build\bospectra_decoder.o build\bitstream_reader.o build\idct.o build\h264_decoder.o build\mjpeg_decoder.o build\mpeg2_decoder.o build\decoder_registry.o build\decoder_diag.o build\decoder_tests.o build\bospectra_audio.o build\audio_bridge.o build\bospectra_audio_session.o build\bospectra_audio_queue.o build\bospectra_audio_diag.o build\bospectra_audio_tests.o build\bospectra_sync.o build\master_clock.o build\drift_detector.o build\bospectra_frame_scheduler.o build\sync_diag.o build\sync_tests.o build\bospectra_render.o build\software_backend.o build\bospectra_opengl_backend.o build\render_pipeline.o build\texture_pool.o build\render_diag.o build\render_tests.o build\bospectra_playback.o build\playback_controller.o build\playback_session.o build\bospectra_playback_state.o build\playback_timeline.o build\playback_events.o build\bospectra_playback_diag.o build\bospectra_playback_tests.o build\bospectra_tests.o build\bospectra_resource_manager.o build\bospectra_sync_manager.o build\bospectra_container_manager.o build\bospectra_decoder_manager.o build\bospectra_render_manager.o build\bospectra_session_manager.o build\bospectra_media_manager.o build\bospectra_v3_container_registry.o build\bospectra_v3_codec_registry.o build\bospectra_v3_renderer_registry.o build\bospectra_v3_probe_engine.o build\bospectra_v3_driver_registry.o build\bospectra_v3_registry.o build\bospectra_v3_packet_queue.o build\bospectra_v3_decode_queue.o build\bospectra_v3_frame_queue.o build\bospectra_v3_renderer_queue.o build\bospectra_v3_pipeline_scheduler.o build\bospectra_v3_pipeline_engine.o build\bospectra_v3_queue_metrics.o build\bospectra_v3_scheduler_clock.o build\bospectra_v3_pts_manager.o build\bospectra_v3_timeline_engine.o build\bospectra_v3_frame_pacer.o build\bospectra_v3_frame_scheduler.o build\bospectra_v3_display_scheduler.o build\bospectra_v3_scheduler_metrics.o build\bospectra_v3_ownership_manager.o build\bospectra_v3_reference_manager.o build\bospectra_v3_lifetime_tracker.o build\bospectra_v3_resource_graph.o build\bospectra_v3_resource_validator.o build\bospectra_v3_leak_detector.o build\bospectra_v3_resource_metrics.o build\bospectra_v3_media_debugger.o build\bospectra_v3_memory_validator.o build\bospectra_v3_ownership_dump.o build\bospectra_v3_resource_dump.o build\bospectra_v3_queue_dump.o build\bospectra_v3_session_dump.o build\bospectra_v3_trace_engine.o build\bospectra_v3_pipeline_validator.o build\bospectra_v3_diagnostic_console.o build\bospectra_v3_telemetry_engine.o build\bospectra_v3_performance_monitor.o build\bospectra_v3_statistics_manager.o build\bospectra_v3_error_manager.o build\bospectra_v3_error_dispatcher.o build\bospectra_v3_error_reporter.o build\bospectra_v3_runtime_health.o build\bospectra_v3_runtime_metrics.o build\bospectra_v3_watchdog_engine.o build\bospectra_v3_watchdog_rules.o build\bospectra_v3_watchdog_monitor.o build\bospectra_v3_watchdog_recovery.o build\bospectra_v3_watchdog_history.o build\bospectra_v3_watchdog_metrics.o build\bospectra_v3_watchdog_console.o build\bospectra_v3_cleanup_engine.o build\bospectra_v3_cleanup_rules.o build\bospectra_v3_cleanup_pipeline.o build\bospectra_v3_cleanup_validator.o build\bospectra_v3_cleanup_metrics.o build\bospectra_v3_cleanup_console.o build\bospectra_v3_cert_engine.o build\bospectra_v3_cert_runner.o build\bospectra_v3_cert_scenarios.o build\bospectra_v3_cert_validator.o build\bospectra_v3_cert_report.o build\bospectra_v3_cert_console.o build\player_core.o build\viewport_view.o build\toolbar_view.o build\playback_controls.o build\playlist_manager.o build\media_library.o build\recent_history.o build\player_settings.o build\player_diag.o build\player_tests.o build\bos_media_player.o -o build\kernel.bin
