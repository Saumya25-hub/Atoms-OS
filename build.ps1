...
clang -target x86_64-pc-none-elf -mno-sse -mno-sse2 -mno-mmx -msoft-float -ffreestanding -mno-red-zone -I. -c kernel\performance\tests\profiler_tests.c -o build\profiler_tests.o
if ($LASTEXITCODE -ne 0) { Write-Host "PPE Failed!" -ForegroundColor Red; exit $LASTEXITCODE }
