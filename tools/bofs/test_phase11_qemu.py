...
PPM_PATH   = r"D:\Signatures_OS\build\phase11_file_manager_dashboard.ppm"
PNG_PATH   = r"D:\Signatures_OS\build\phase11_file_manager_dashboard.png"
ARTIFACT_PNG = r"C:\Users\Saumya Chaudhari\.gemini\antigravity-ide\brain\cb7bd3da-a317-4942-a83f-2cc475b30df3\phase11_file_manager_dashboard.png"
SERIAL_LOG = r"D:\Signatures_OS\build\phase11_file_manager_serial.log"
...
print("[TEST] Launching QEMU pure UEFI — BOFS Phase 11 File Manager Integration Dashboard...")
proc = subprocess.Popen(cmd)

print("[TEST] Monitoring serial log for BOFS Phase 11 completion...")
    ...
    if os.path.exists(SERIAL_LOG):
        try:
            with open(SERIAL_LOG, "r", errors="ignore") as f:
                log_data = f.read()
                if "[PHASE11] Phase 11 File Manager Integration Test Complete: MASTER CERTIFICATION PASS" in log_data:
                    print(f"[TEST] BOFS Phase 11 completed successfully after {time.time() - start_time:.1f}s!")
                    test_completed = True
                    break
        except Exception:
            pass
...
try:
    print("[TEST] Connecting to QEMU monitor on port 4455...")
